...
async function obterTokenDeAcesso() {
    const tenantId = '74ca36cd-8cdb-4647-b46d-03042680829c';         // Substitua pelo seu Tenant ID
    const clientId = '78d4a8a2-8dc8-4346-a0c5-de3ca1fa7d5e';         // Substitua pelo seu Client ID
    const clientSecret = 'cfY8Q~bnOpB-_qVrWq~kChhuTZmeNifUuHZ_ga_j'; // Substitua pelo seu Client Secret
